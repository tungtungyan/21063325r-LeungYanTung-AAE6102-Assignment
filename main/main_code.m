...
Tr_tab = [iter, nan, nan, nan, nan, nan, XR', dtR, dtR*c, wlat, wlon, walt, nan]; % Trace table to trace variable change
...
while 1
   ...
   % tropospheric error (saastamoinen model)
    ...
    Tr_tab = [Tr_tab; iter, dx', residualSE, XR', dtR, dtR*c, wlat, wlon, walt, posErr];
    fprintf('\n----------------\n');
    fprintf('\nTime of Iteration: %d\n', iter);
